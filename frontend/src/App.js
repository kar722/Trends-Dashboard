...
function App() {
 ...
 // New state to delay plot rendering until stable
       ...
       data={[
         {
           ...
           colorbar: { title: 'Interest', thickness: 20, len: 0.9 },
           hoverinfo: 'text',
           showscale: true,
           zmin: 0,
           zmax: maxValue
                 ...
                 <>
                   {selectedSource === 'google' && trendsData && (
                     <div className="space-y-8">
                       <div className="bg-white rounded-lg shadow">{renderTimeSeriesChart()}</div>
                       <div className="bg-white rounded-lg shadow">{renderRegionalMap()}</div>
                     </div>
                   )}
                   {selectedSource === 'youtube' && (
                     <YouTubeSection
